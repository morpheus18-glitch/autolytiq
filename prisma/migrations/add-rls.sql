...
SELECT ensure_tenant_policy('Appraisal');
SELECT ensure_tenant_policy('ReconItem');
SELECT ensure_tenant_policy('PriceHistory');
SELECT ensure_tenant_policy('AuctionPurchase');
SELECT ensure_tenant_policy('WholesaleListing');
SELECT ensure_tenant_policy('MarketComp');
