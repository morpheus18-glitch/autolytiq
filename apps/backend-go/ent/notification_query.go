...
func (_q *NotificationQuery) QueryTenant() *TenantQuery {
...
func (_q *NotificationQuery) WithTenant(opts ...func(*TenantQuery)) *NotificationQuery {
	query := (&TenantClient{config: _q.config}).Query()
...
//		GroupBy(notification.FieldTenantID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Notification.Query().
//		Select(notification.FieldTenantID).
//		Scan(ctx, &v)
...
func (_q *NotificationQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Notification, error) {
	...
	if query := _q.withTenant; query != nil {
		if err := _q.loadTenant(ctx, query, nodes, nil,
			func(n *Notification, e *Tenant) { n.Edges.Tenant = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *NotificationQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*Notification, init func(*Notification), assign func(*Notification, *Tenant)) error {
...
func (_q *NotificationQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withTenant != nil {
			_spec.Node.AddColumnOnce(notification.FieldTenantID)
		}
		if _q.withUser != nil {
