...
var designTokens = {
  ...
  colors: {
    ...
    neutral: {
      0: "#FFFFFF",
      50: "#F8FAFC",
      // Softer white for light mode backgrounds
      100: "#F1F5F9",
      // Light gray for subtle surfaces
      200: "#E2E8F0",
      ...
      // Darker text
      800: "#1E293B",
      // Very dark gray for text on light
      900: "#0F172A",
    ...
    status: {
      ok: "#22C55E",
      // green-500 - success/healthy state
      caution: "#F59E0B",
      // orange-500 - warning/attention needed
      risk: "#EF4444",
      // red-500 - error/critical issue
      critical: "#DC2626",
      // red-600 - urgent/severe issue
      info: "#3B82F6",
      // blue-500 - informational
      muted: "#64748B"
      // gray-500 - neutral/inactive
    }
  },
  ...
  surface: {
    light: {
      ...
      elevated: "#FFFFFF",
      // Cards and modals - pure white with shadow
      subtle: "#F1F5F9",
      // Subtle backgrounds
      hover: "#E2E8F0",
      // Hover states
    ...
    dark: {
      base: "#0D1117",
      // Main background - GitHub dark inspired
      elevated: "#161B22",
  ...
  text: {
    ...
    dark: {
      primary: "#F1F5F9",
      // Main text - soft white, not harsh
      secondary: "#CBD5E1",
      // Secondary text
      tertiary: "#94A3B8",
      // Muted text
  ...
  typography: {
    ...
    fontSize: {
      ...
      // 11px - tiny labels
      sm: "0.8125rem",
      // 13px - small text, better for density
      base: "0.9375rem",
      // 15px - body text, crisp at any DPI
      lg: "1.0625rem",
      // 17px - emphasized text
      xl: "1.1875rem",
      // 19px - large text
      "2xl": "1.375rem",
      // 22px - headings
  ...
  borders: {
    ...
    radius: {
      ...
      // 4px
      base: "0.375rem",
      // 6px - slightly rounder for premium feel
      md: "0.5rem",
      // 8px
      lg: "0.75rem",
      // 12px
  ...
  layout: {
    ...
    header: {
      height: "56px"
      // Slightly shorter for more content
    }
  },
  // ═════════════════════════════════════════════════════════════════════════
...
var HEX_REGEX = /^#?([a-f\d]{3}|[a-f\d]{6})$/i;
var expandHex = (hex) => {
...
function responsiveSpacing(mobile, desktop) {
  return {
    base: designTokens.spacing[mobile],
    md: designTokens.spacing[desktop]
  };
}
var themes = {
  light: {
...
function getTheme() {
  ...
  const stored = typeof localStorage !== "undefined" ? localStorage.getItem("autolytiq-theme") : null;
