...
func (_q *CustomerQuery) QueryTenant() *TenantQuery {
...
func (_q *CustomerQuery) QueryAssignedTo() *UserQuery {
...
func (_q *CustomerQuery) QueryDeals() *DealQuery {
...
func (_q *CustomerQuery) QueryLeads() *LeadQuery {
...
func (_q *CustomerQuery) QueryTradeIns() *TradeInQuery {
...
func (_q *CustomerQuery) Clone() *CustomerQuery {
	...
	return &CustomerQuery{
		...
		withAssignedTo: _q.withAssignedTo.Clone(),
...
func (_q *CustomerQuery) WithTenant(opts ...func(*TenantQuery)) *CustomerQuery {
	query := (&TenantClient{config: _q.config}).Query()
...
func (_q *CustomerQuery) WithAssignedTo(opts ...func(*UserQuery)) *CustomerQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withAssignedTo = query
	return _q
}
...
func (_q *CustomerQuery) WithDeals(opts ...func(*DealQuery)) *CustomerQuery {
	query := (&DealClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *CustomerQuery) WithLeads(opts ...func(*LeadQuery)) *CustomerQuery {
	query := (&LeadClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *CustomerQuery) WithTradeIns(opts ...func(*TradeInQuery)) *CustomerQuery {
	query := (&TradeInClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *CustomerQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Customer, error) {
	...
	if query := _q.withTenant; query != nil {
		if err := _q.loadTenant(ctx, query, nodes, nil,
			func(n *Customer, e *Tenant) { n.Edges.Tenant = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withAssignedTo; query != nil {
		if err := _q.loadAssignedTo(ctx, query, nodes, nil,
			func(n *Customer, e *User) { n.Edges.AssignedTo = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withDeals; query != nil {
		if err := _q.loadDeals(ctx, query, nodes,
			func(n *Customer) { n.Edges.Deals = []*Deal{} },
			func(n *Customer, e *Deal) { n.Edges.Deals = append(n.Edges.Deals, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withLeads; query != nil {
		if err := _q.loadLeads(ctx, query, nodes,
			func(n *Customer) { n.Edges.Leads = []*Lead{} },
			func(n *Customer, e *Lead) { n.Edges.Leads = append(n.Edges.Leads, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withTradeIns; query != nil {
		if err := _q.loadTradeIns(ctx, query, nodes,
			func(n *Customer) { n.Edges.TradeIns = []*TradeIn{} },
			func(n *Customer, e *TradeIn) { n.Edges.TradeIns = append(n.Edges.TradeIns, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *CustomerQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*Customer, init func(*Customer), assign func(*Customer, *Tenant)) error {
...
func (_q *CustomerQuery) loadAssignedTo(ctx context.Context, query *UserQuery, nodes []*Customer, init func(*Customer), assign func(*Customer, *User)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*Customer)
	for i := range nodes {
...
func (_q *CustomerQuery) loadDeals(ctx context.Context, query *DealQuery, nodes []*Customer, init func(*Customer), assign func(*Customer, *Deal)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(deal.FieldCustomerID)
	}
	query.Where(predicate.Deal(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(customer.DealsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *CustomerQuery) loadLeads(ctx context.Context, query *LeadQuery, nodes []*Customer, init func(*Customer), assign func(*Customer, *Lead)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Customer)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(lead.FieldCustomerID)
	}
	query.Where(predicate.Lead(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(customer.LeadsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *CustomerQuery) loadTradeIns(ctx context.Context, query *TradeInQuery, nodes []*Customer, init func(*Customer), assign func(*Customer, *TradeIn)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Customer)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(tradein.FieldCustomerID)
	}
	query.Where(predicate.TradeIn(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(customer.TradeInsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *CustomerQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withTenant != nil {
			_spec.Node.AddColumnOnce(customer.FieldTenantID)
		}
		if _q.withAssignedTo != nil {
			_spec.Node.AddColumnOnce(customer.FieldAssignedToUserID)
		}
	}
