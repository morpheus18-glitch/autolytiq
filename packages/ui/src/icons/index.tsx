...
export const Settings: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M12 1v6m0 6v6m5.2-13a9 9 0 0 1 0 14m-10.4 0a9 9 0 0 1 0-14M1 12h6m6 0h6" />
  </svg>
);
...
export const Car: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M5 17h2m10 0h2M7 17a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm10 0a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm-9-9h8l1.5 4.5H4.5L6 8z" />
    <path d="M3 11.5V17a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-5.5" />
  </svg>
);
