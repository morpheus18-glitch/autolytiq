...
### 5. DOCUMENTATION LOCATION RULE
```
ALL .md files MUST live in docs/ directory (except README.md at root)

❌ NEVER create .md files at root level (except README.md)
❌ NEVER create DESIGN.md, NOTES.md, PLAN.md at root
❌ NEVER scatter docs in apps/ or packages/ (except package READMEs)

✅ ALWAYS put docs in docs/ subdirectories:
   docs/specs/          - Feature specifications
   docs/ui/             - Component library docs
   docs/architecture/   - System design
   docs/deployment/     - Ops & deployment
...
✅ ALLOWED exceptions:
   ...
   infrastructure/*/README.md (infra-specific)

🔍 Pre-commit check validates this rule
```
