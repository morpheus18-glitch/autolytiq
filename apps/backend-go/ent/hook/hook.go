...
// The AICounterOfferFunc type is an adapter to allow the use of ordinary
// function as AICounterOffer mutator.
type AICounterOfferFunc func(context.Context, *ent.AICounterOfferMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AICounterOfferFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AICounterOfferMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AICounterOfferMutation", m)
}
...
// The DealWorksheetFunc type is an adapter to allow the use of ordinary
// function as DealWorksheet mutator.
type DealWorksheetFunc func(context.Context, *ent.DealWorksheetMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f DealWorksheetFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.DealWorksheetMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.DealWorksheetMutation", m)
}
...
// The LeadScoreFunc type is an adapter to allow the use of ordinary
// function as LeadScore mutator.
type LeadScoreFunc func(context.Context, *ent.LeadScoreMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f LeadScoreFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.LeadScoreMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.LeadScoreMutation", m)
}
...
// The TradeInFunc type is an adapter to allow the use of ordinary
// function as TradeIn mutator.
type TradeInFunc func(context.Context, *ent.TradeInMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TradeInFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TradeInMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TradeInMutation", m)
}
